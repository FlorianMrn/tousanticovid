...
const JeSuisSolidaire = () => {
    ...
    return (
        <section className="remative w-full pt-32 px-2 md:px-4 max-w-screen-lg m-auto lg:flex lg:justify-between">
            <main className="w-full">
                ...
                <div className="py-2 text-center relative">
                    ...
                    <button onClick={handleOpen} className="lg:hidden font-marianne text-button font-bold bg-blue rounded shadow text-white px-2 py-4 my-4">Signer cette pétition</button>
                    {openForm && 
                        <div className="absolute -bottom-5 w-full h-screen bg-blue-info px-8 py-4 pt-16 md:pt-44 right-100">
                            ...
                            <form className="text-center">
                                <input onChange={handleChange} type="text" value={data.nom} name="nom" placeholder="Nom" className="font-marianne block my-4 py-2 px-4 outline-none border-blue border shadow w-full focus:ring-4 focus:ring-blue"/>
                                <input onChange={handleChange} type="text" value={data.prenom} name="prenom" placeholder="Prénom" className="font-marianne block my-4 py-2 px-4 outline-none border-blue border shadow w-full focus:ring-4 focus:ring-blue"/>
                                <input onChange={handleChange} type="text" value={data.email} name="email" placeholder="Email" className="font-marianne block my-4 py-2 px-4 outline-none border-blue border shadow w-full focus:ring-4 focus:ring-blue"/>
                                <input onChange={handleChange} type="text" value={data.ville} name="ville" placeholder="Ville" className="font-marianne block my-4 py-2 px-4 outline-none border-blue border shadow w-full focus:ring-4 focus:ring-blue"/>
                                <input onChange={handleChange} type="text" value={data.cp} name="cp" placeholder="Code postal" className="font-marianne block my-4 py-2 px-4 outline-none border-blue border shadow w-full focus:ring-4 focus:ring-blue"/>
