        ...
        <section className="w-full pt-32 px-2 md:px-4 max-w-screen-lg m-auto">
            ...
            <main className="flex justify-center flex-wrap">
                <div className="text-left w-full pb-4 text-blue">
                    ...
                    <ul className="text-grey font-marianne">
                        <li><FaCheck className="inline mr-2 text-blue"/>Faire baisser la mortalité et les formes graves</li>
                        <li><FaCheck className="inline mr-2 text-blue"/>Protéger les soignants et le système de soins</li>
                        <li><FaCheck className="inline mr-2 text-blue"/>Garantir la sécurité des vaccins et de la vaccination</li>
                    </ul>
                </div>
                <div className="text-left w-full pb-4  text-blue">
                    <h2 className="text-subheader pb-2">Trois Principes</h2>
                    <ul className="text-grey font-marianne">
                        <li><FaStar className="inline mr-2 text-blue"/>Non obligatoire</li>
                        <li><FaStar className="inline mr-2 text-blue"/>Gratuité</li>
                        <li><FaStar className="inline mr-2 text-blue"/>Haute sécurité</li>
                    </ul>
                </div>
                <div className="w-full pb-4 bg-blue p-4 mt-4">
            ...
            <aside className="flex justify-center flex-wrap">
                <div className="w-full">
                    <div className="w-full h-16 md:h-36 overflow-hidden">
